    ...
    <>
      ...
      <div className="flex justify-center gap-3 mt-32">
        ...
        <Link
          onClick={() => window.top(0, 0)}
          to="/gallery/page-2"
          className="text-white inline-flex items-center justify-center text-center text-[18px] border border-solid border-[#dee2e6] w-[48px] h-[45px] font-medium rounded-md bg-[#4cfa50] "
        >
          2
        </Link>
      </div>
